...
# Verified Boot
STOCK_SECURITY_PATCH_TIMESTAMP := $(shell date -d 'TZ="GMT" 2025-07-05' +%s)
BOARD_AVB_ENABLE := true

ifneq (,$(AVB_RSA4096_KEY_PATH))
ifeq (,$(AVB_RSA2048_KEY_PATH))
$(error AVB_RSA2048_KEY_PATH must be set if AVB_RSA4096_KEY_PATH is set!)
endif
BOARD_AVB_ALGORITHM := SHA256_RSA4096
BOARD_AVB_KEY_PATH := $(AVB_RSA4096_KEY_PATH)
else
BOARD_AVB_MAKE_VBMETA_IMAGE_ARGS += --flags 3
AVB_RSA2048_KEY_PATH := external/avb/test/data/testkey_rsa2048.pem
AVB_RSA4096_KEY_PATH := external/avb/test/data/testkey_rsa4096.pem
endif

BOARD_MOVE_GSI_AVB_KEYS_TO_VENDOR_BOOT := true

BOARD_AVB_RECOVERY_KEY_PATH := $(AVB_RSA4096_KEY_PATH)
BOARD_AVB_RECOVERY_ALGORITHM := SHA256_RSA4096
BOARD_AVB_RECOVERY_ROLLBACK_INDEX := 1
BOARD_AVB_RECOVERY_ROLLBACK_INDEX_LOCATION := 1

BOARD_AVB_VBMETA_SYSTEM := system system_ext product
BOARD_AVB_VBMETA_SYSTEM_KEY_PATH := $(AVB_RSA4096_KEY_PATH)
BOARD_AVB_VBMETA_SYSTEM_ALGORITHM := SHA256_RSA4096
BOARD_AVB_VBMETA_SYSTEM_ROLLBACK_INDEX := $(STOCK_SECURITY_PATCH_TIMESTAMP)
BOARD_AVB_VBMETA_SYSTEM_ROLLBACK_INDEX_LOCATION := 2

BOARD_AVB_BOOT_KEY_PATH := $(AVB_RSA4096_KEY_PATH)
BOARD_AVB_BOOT_ALGORITHM := SHA256_RSA4096
BOARD_AVB_BOOT_ROLLBACK_INDEX := $(STOCK_SECURITY_PATCH_TIMESTAMP)
BOARD_AVB_BOOT_ROLLBACK_INDEX_LOCATION := 3

BOARD_AVB_INIT_BOOT_KEY_PATH := $(AVB_RSA2048_KEY_PATH)
